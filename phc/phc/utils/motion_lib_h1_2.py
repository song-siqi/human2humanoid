...
class MotionLibH1_2(MotionLibBase):
    ...
    def __init__(self, motion_file, device, fix_height=FixHeightMode.no_fix, masterfoot_conifg=None,
                 min_length=-1, im_eval=False, multi_thread=True,
                 extend_hand = False,
                 extend_head = False,
                 mjcf_file="resources/robots/h1_2/h1_2_handless.xml",
                ):
    ...
    def load_motions(self, skeleton_trees, gender_betas, limb_weights, random_sample=True, start_idx=0, max_len=-1, target_heading = None):
        ...
        # above is the accelerated version of data loading and initialization, below is to load it into the motion_lib
